...
extension Capital {
    ...
    static let dublin = Capital(latitude: 53.33306, longitude: -6.24889)
    ...
    static let luxembourg = Capital(latitude: 49.61167, longitude: 6.13)
    ...
    static let lisbon = Capital(latitude: 38.71667, longitude: -9.13333)
